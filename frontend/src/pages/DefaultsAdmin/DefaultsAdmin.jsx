...
const DefaultsAdmin = () => {
  ...
  return (
    <div className="defaultsAdmin-container">
      <Header
      ...
      {problems &&
        (problems.length === 0 ? (
          <div className="defaults-displayOff">
          ...
          <div className="defaults-displayOn">
            {problems.map((problem) => (
              <div className="map-container" key={problem.id_default}>
                ...
                <Button
                  name="delete"
                  classButton="delete-button-defaultsAdmin"
                ...
                <Link to={`/DefaultViewAdmin/${cp}/${problem.id_default}`}>
                  <Button
                    name="update"
                    classButton="update-button-defaultsAdmin"
