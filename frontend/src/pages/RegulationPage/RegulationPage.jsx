...
const RegulationPage = () => {
  return (
    <div>
      <Header
        backCss="backRegulation"
        profileCss="profileRegulation"
        loginCss="loginRegulation"
      />
      <div className="legal-container">
        ...
        <div className="identity-container">
          ...
          <br />
          <ul>
            <li>Nom du site web : Info Defaut</li>
            <li>Adresse: 44 rue Alphonse Penaud 75020 Paris </li>
            <li>
              Propriétaire, animation, conception et réalisation : Marion
              Chateau Villot, Marina Alves Domingues, Antoine Carpentier, Eric
              Vieira
            </li>
        ...
        <div className="property-container">
          ...
          <p>
            ...
            les droits de propriété intellectuelle ou les droits d’usage.1{" "}
            <br />
            <br />
        ...
        <div className="privacy-container">
          ...
          <p>
            ...
            sa demande écrite et signée, accompagnée d’une preuve
            d’identité.5678
            <br />
            <br />
        ...
        <div className="mentions-container">
          ...
          <ol>
            ...
            <li>
              Loi n° 78-87 du 6 janvier 1978, modifiée par la loi n° 2004-801 du
              6 août 2004, relative à l’informatique, aux fichiers et aux
              libertés
            </li>
            <li>
